...
private val japaneseCoursesStrings = CoursesStrings(
    title = "コース",
    description = "すべての HSK パックを無料でプレビューできます。レッスンをオフラインで維持したいときにプレミアムレベルを解放してください。",
    emptyCatalogMessage = "コースデータが見つかりません。assets/learn-datas がバンドルされているか確認してください。",
    filterAll = "すべて",
    filterRemaining = "未完了",
    filterCompleted = "完了",
    legendTitle = "凡例",
...
private val japaneseAccountStrings = AccountStrings(
    ...
    signInDescriptionSignedIn = "サインイン済み。購入と解放済みレベルはこの端末にリンクされています。",
    signInDescriptionSignedOut = "ゲストモードでは練習データが端末内に留まります。コースを解放したいときだけサインインしてください。",
    signInButtonSignedIn = "サインアウト",
    signInButtonSignedOut = "ポリシーに同意してサインイン",
    courseCardTitle = "コース解放",
    courseDescriptionSignedOut = "いつでも HSK レベルをプレビューできます。購入チェックリストを進めるにはサインインが必要です。",
    courseDescriptionUnlocked = "すべてのプレミアムレベルが解放されました。コースタブから続行してください。",
    courseDescriptionLocked = "一度の解放でローカルライセンスを保存し、レッスンをオフラインで維持します。",
    courseButtonSignedOut = "サインインが必要",
    courseButtonUnlocked = "コースを開く",
    courseButtonLocked = "全コースを解放",
    supportTitle = "サポートとコンプライアンス",
    supportDescription = "ヘルプ記事・プライバシー設定・フィードバックフォームをここに集約し、ログインや購入の前に必ず確認できます。",
    supportFeedbackButton = "フィードバックを送る",
    consentSignInTitle = "サインイン前の確認",
    consentSignInBullets = listOf(
        "サインインは購入を結び付ける場合のみ必要で、練習データは端末に保存されます。",
        "続行するとプライバシーポリシーを確認済みであると見なされます。",
        "いつでもゲストモードにとどまれます。プレミアムレッスンは単にロックされたままです。",
    ),
    ...
    consentUnlockBullets = listOf(
        ...
        "チェックアウト時にもコンプライアンスのためのプライバシー通知が表示されます。",
    ),
...
private val japaneseSupportStrings = SupportStrings(
    analyticsTitle = "利用状況の解析",
    analyticsDescription = "今後の機能向けの匿名カウンター。",
    ...
    feedbackSavedMessage = "メモは端末に保存されました。次回のリリースで診断データと一緒にエクスポートされます。",
    ...
    feedbackContactPlaceholder = "メールやID",
    ...
    feedbackLogNoApps = "共有できるアプリがありません。",
