...
private val spanishLibraryStrings = LibraryStrings(
    title = "Diccionario",
    description = "Consulta pinyin, radicales y definiciones r?pidas totalmente sin conexi?n. Escribe un solo car?cter y regresa a Pr?ctica cuando quieras trazar.",
    inputLabel = "Car?cter chino",
    supportingText = "Consejo: escribe un car?cter (HSK 1 viene desbloqueado).",
    quickTryLabel = "Prueba:",
    recentHeader = "B?squedas recientes",
    recentClear = "Limpiar",
    recentOverflowLabel = "M?s...",
    recentOverflowDialogTitle = "B?squedas recientes",
    recentOverflowClose = "Cerrar",
    lookupLabel = "Buscar",
    lookupLoadingLabel = "Buscando...",
    clearResultLabel = "Borrar resultado",
    helpTitle = "Consejos",
    helpBody = "- Los datos provienen del word.json incluido, as? funciona sin conexi?n.\n- Desbloquea lecciones adicionales en la pesta?a Cuenta para combinar el diccionario con los cursos.\n- Para detalles de escritura y privacidad revisa docs/help-guide.md dentro del proyecto.",
    pinyinLabelFormat = "Pinyin ? %1\$s",
    radicalsStrokesFormat = "Radical ? %1\$s    Trazos ? %2\$s",
    traditionalLabelFormat = "Tradicional ? %1\$s",
    definitionFallback = "Sin definici?n disponible.",
    valueNotAvailable = "N/D",
    valueUnknown = "?",
    practiceButtonLabel = "Practicar este car?cter",
    quickSuggestions = listOf("?", "?", "?", "?", "?"),
    errorEmpty = "Ingresa un car?cter para buscar.",
    errorNotFound = "Car?cter no encontrado en el diccionario sin conexi?n.",
...
private fun localizedStringsJa(locale: Locale): LocalizedStrings = LocalizedStrings(
    ...
    clearButton = "クリア",
    loadingLabel = "読み込み中...",
    coursesDialogTitle = "HSK コース",
    coursePlanHeading = "続けるコースを選択",
    courseIntroTitle = "コースの仕組み",
    courseIntroBullets = listOf(
        "HSK レベルを選んで開始、または中断した場所から再開できます。",
        "文字をタップすると練習、長押しで習得済みにできます。",
        "ボード上のバッジは現在のコース進捗を常に表示します。",
    ),
    courseEmptyTitle = "まだコースがありません",
    courseEmptyDescription = "下の HSK レベルを選んでガイド付きセッションを始めてください。",
    courseNoDataMessage = "コースデータが見つかりません。リソースパックを確認してください。",
    expandCharactersLabel = "すべて表示",
    collapseCharactersLabel = "隠す",
    legendTitle = "凡例とジェスチャー",
    legendGesture = "文字をタップして練習・長押しで習得済みにします。",
    legendActiveLabel = "進行中",
    legendCompletedLabel = "完了",
    legendRemainingLabel = "未完了",
    courseLegendHint = "バッジから再開/スキップ/やり直し/終了ができ、ボードを覆いません。",
    courseLevelCompleteLabel = "コース完了",
    courseLevelStartFormat = "%s から開始",
    courseLevelNextFormat = "次へ · %s",
    levelLabelFormat = "レベル %d",
    courseLevelProgressFormat = "%1\$d/%2\$d 習得 · 残り %3\$d",
    loadLevelFormat = "HSK %d を読み込む",
    filterAllLabel = "すべて",
    filterRemainingLabel = "未完了",
    filterCompletedLabel = "完了",
    helpTitle = "ヘルプとオンボーディング",
    helpSections = listOf(
        HelpSectionText(
            title = "クイックスタート",
            description = "デモから練習まで数秒で体験できます。",
            bullets = listOf(
                "漢字を入力して雲アイコンを押し、オフラインデータを読み込みます。",
                "再生/ループでデモを視聴。書道テンプレートをオンにするとトレースできます。",
                "ボードの鉛筆で開始。ヒントアイコンは次の画をハイライトします。",
            ),
        ),
        HelpSectionText(
            title = "コースと進捗",
            description = "HSK コースはアバターメニューにあり、バッジが状態を映します。",
            bullets = listOf(
                "再開/スキップ/やり直し/終了ボタンはバッジ内にあり、ボードを邪魔しません。",
                "矢印で文字を切り替え、完了するとすぐにサマリーが更新されます。",
            ),
        ),
        HelpSectionText(
            title = "カードと発音",
            description = "楷書カードには辞書データと TTS が含まれます。",
            bullets = listOf(
                "カードをタップして詳細な定義を開き、スクロールして確認します。",
                "スピーカーボタンで完全オフラインの音声を再生します。",
            ),
        ),
        HelpSectionText(
            title = "グリッドとテンプレート",
            description = "ボード設定で米字格・九宮格・ガイドなしを切り替えられます。",
            bullets = listOf(
                "輪郭とフリーハンドを切り替え、ストロークカラーはセッション間で保持されます。",
                "キャンバス外をスクロールしてページを動かすと、書く面が固定されます。",
            ),
        ),
        HelpSectionText(
            title = "サポートとフィードバック",
            description = "困ったときはいつでもご連絡ください。",
            bullets = listOf(
                "メール: qq260316514@gmail.com",
                "プロフィール→フィードバックからログを添付して送信できます。",
            ),
        ),
    ),
    helpConfirm = "了解",
    privacyTitle = "プライバシー設定",
    privacyIntro = "すべての機能はデフォルトでオフラインです。許可する場合のみ診断を有効化してください。",
    dataSafetyHeading = "データ安全の概要",
    privacySummaryRows = listOf(
        SummaryRowText(
            title = "データ保存",
            detail = "練習履歴・コース進捗・ボード設定は端末内の DataStore にのみ保存されます。",
        ),
        SummaryRowText(
            title = "オフラインアセット",
            detail = "ストローク JSON とコースパックは APK に含まれており、手動プリフェッチもしません。",
        ),
        SummaryRowText(
            title = "ログとフィードバック",
            detail = "テキストログは明示的にフィードバックを送信したときのみ添付されます。",
        ),
    ),
    ...
    fullPolicySections = listOf(
        PolicySectionText(
            title = "1. 収集するデータ",
            bullets = listOf(
                "筆順描画のために APK に同梱された文字リソース。",
                "セッション再開用に最大 40 件のローカル練習記録。",
                "グリッドや色、テンプレート可視性などのボード設定。",
                "フィードバック送信時にのみ添付する任意のテキストログ。",
            ),
        ),
        PolicySectionText(
            title = "2. 利用目的",
            bullets = listOf(
                "ローカルでコース進捗を再開し、連続日数を計算します。",
                "ネット接続なしで辞書カードと HSK 要約を表示します。",
                "共有された場合に限りログを調査します。",
            ),
        ),
        PolicySectionText(
            title = "3. パーミッション",
            bullets = listOf(
                "INTERNET(任意): 今後のダウンロードや外部辞書リンクのために予約。",
        ...
        PolicySectionText(
            title = "4. あなたのコントロール",
            bullets = listOf(
                "Android 設定からアプリのストレージを消すと全データがリセットされます。",
                "プライバシーダイアログで分析・クラッシュログ・プリフェッチを切り替えられます。",
                "送信前にログを確認・編集できます。",
            ),
        ),
        PolicySectionText(
