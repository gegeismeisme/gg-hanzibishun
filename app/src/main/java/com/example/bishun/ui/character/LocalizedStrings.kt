...
private fun localizedStringsJa(locale: Locale): LocalizedStrings = LocalizedStrings(
    ...
    library = LibraryStrings(
        title = "辞書",
        description = "ピンイン・部首・意味を完全オフラインで検索。1 文字入力すれば、いつでも練習に戻れます。",
        inputLabel = "漢字",
        supportingText = "ヒント: 1 文字 (HSK1 は最初から解放済み) を入力してください。",
        quickTryLabel = "お試し:",
        recentHeader = "最近の検索",
        recentClear = "履歴を消去",
        lookupLabel = "検索",
        ...
        helpTitle = "ヒント",
        helpBody = "- データは同梱の word.json を利用するため完全にオフラインで動作します。\n- アカウントタブで追加レッスンを解放すると辞書とコースを連携できます。\n- 書き順とプライバシーの詳細は docs/help-guide.md を参照してください。",
        pinyinLabelFormat = "ピンイン · %1\$s",
        radicalsStrokesFormat = "部首 · %1\$s    画数 · %2\$s",
        traditionalLabelFormat = "繁体 · %1\$s",
        definitionFallback = "定義が見つかりません。",
        valueNotAvailable = "N/A",
        valueUnknown = "?",
        practiceButtonLabel = "この文字を練習",
        quickSuggestions = listOf("永", "水", "好", "人", "学"),
        errorEmpty = "検索する漢字を 1 文字入力してください。",
        errorNotFound = "オフライン辞書に文字が見つかりません。",
