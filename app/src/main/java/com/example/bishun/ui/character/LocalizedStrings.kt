...
private fun localizedStringsJa(locale: Locale): LocalizedStrings = LocalizedStrings(
    ...
    progress = ProgressStrings(
        title = "進捗",
        description = "HSK の達成状況、連続日数、最近の練習履歴を確認できます。文字を書くたびに即時更新されます。",
        jumpBackLabel = "練習に戻る",
        learnedLabel = "習得済み",
        streakLabel = "連続日数",
        lastSessionLabel = "最終セッション",
        streakDaySingularFormat = "%1\$d 日",
        streakDayPluralFormat = "%1\$d 日",
        streakStartLabel = "開始",
        lastSessionNeverLabel = "未実施",
        weeklyChartTitle = "直近 7 日",
        levelsTitle = "レベル",
        levelsEmpty = "練習を開始すると、ここに HSK レベルの状態が表示されます。",
        levelLabelFormat = "HSK %1\$d",
        levelMasteredFormat = "%1\$d/%2\$d 文字",
        levelJumpDescription = "次の文字へ移動",
        levelBrowseCourses = "コースを見る",
        historyTitle = "最近の練習",
        historyEmpty = "文字を書くとすぐにここへ追加され、素早く復習できます。",
        historyStrokesFormat = "%1\$d 画 · %2\$s",
        historyMistakesPerfect = "ミスなし",
        historyMistakesFormat = "ミス %1\$d 回",
        historyLoadCharacterFormat = "%1\$s を読み込む",
        relativeJustNow = "たった今",
        relativeMinutesFormat = "%1\$d 分前",
        relativeHoursFormat = "%1\$d 時間前",
        relativeDaysFormat = "%1\$d 日前",
    ),
