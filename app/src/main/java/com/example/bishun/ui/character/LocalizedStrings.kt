...
private val japaneseCoursesStrings = CoursesStrings(
    title = "コース",
    description = "すべての HSK パックを無料でプレビューできます。オフラインで学びたいレベルだけアンロックしてください。",
    ...
    levelNextFormat = "次へ · %1\$s",
    levelCompletedLabel = "完了",
    lockedSignInLabel = "サインイン",
    lockedUnlockLabel = "解除",
    lockedBrowseLabel = "コースを見る",
    lockedGreatJobLabel = "お疲れさま！",
    iconStartDescriptionFormat = "HSK %1\$d を開く",
)


private val japaneseAccountStrings = AccountStrings(
    title = "アカウントと購入",
    signInCardTitle = "サインイン状況",
    signInDescriptionSignedIn = "サインイン済みです。購入と解放済みレベルはこの端末にリンクされています。",
    signInDescriptionSignedOut = "ゲストモードでは練習データは端末に残ります。追加レッスンを解放したいときだけサインインしてください。",
    signInButtonSignedIn = "サインアウト",
    signInButtonSignedOut = "ポリシーに同意してサインイン",
    courseCardTitle = "コース解放",
    courseDescriptionSignedOut = "HSK レベルはいつでもプレビューできます。購入チェックリストを進めるにはサインインが必要です。",
    courseDescriptionUnlocked = "プレミアムレベルはすべて解放されました。コースタブから続行してください。",
    courseDescriptionLocked = "1 度の解放でライセンスを端末に保存し、レッスンをオフラインで維持します。",
    courseButtonSignedOut = "サインインが必要",
    courseButtonUnlocked = "コースを開く",
    courseButtonLocked = "全コースを解放",
    supportTitle = "サポートとコンプライアンス",
    supportDescription = "ヘルプ記事、プライバシー設定、フィードバックフォームをまとめました。ログインや購入の前に確認できます。",
    supportFeedbackButton = "フィードバックを送る",
    clearDataTitle = "ローカルデータをリセット",
    clearDataDescription = "この端末の練習履歴・進捗・購入状態・設定をすべて消去します。",
    clearDataButton = "端末データを削除",
    clearDataDialogTitle = "ローカルデータを削除しますか？",
    clearDataDialogBody = "練習履歴、連続日数、解放済みレベル、設定、辞書の履歴が端末から削除されます。この操作は元に戻せません。",
    consentSignInTitle = "サインイン前の確認",
    consentSignInBullets = listOf(
        "サインインは購入を関連付ける場合のみ必要で、練習データは端末に保存されます。",
        "続行するとプライバシーポリシーを確認済みとみなされます。",
        "ゲストモードのままでも構いません。プレミアムレッスンはロックされたままです。",
    ),
    consentSignInConfirm = "同意してサインイン",
    consentUnlockTitle = "プレミアムレッスンを解放",
    consentUnlockBullets = listOf(
        "支払いトークンは端末にキャッシュされるため、すべてオフラインで動作します。",
        "解放内容はアカウントタブにも記録され、後で復元できます。",
        "決済時にもコンプライアンス用のプライバシー通知が表示されます。",
    ),
    consentUnlockConfirm = "解放を確定",
...
private val japaneseSupportStrings = SupportStrings(
    ...
    analyticsDescription = "今後の機能に備える匿名カウンターです。",
    crashTitle = "クラッシュレポート",
    crashDescription = "描画に失敗した際の軽量ログを共有します。",
    prefetchTitle = "ネットワークプリフェッチ",
    prefetchDescription = "将来のパックを Wi‑Fi で先読みします。",
    privacyCloseLabel = "閉じる",
    feedbackTitle = "フィードバックを送信",
    feedbackThanksTitle = "ありがとうございます",
    feedbackSavedMessage = "メモは端末に保存されました。次回のリリースで診断と一緒にエクスポートされます。",
    feedbackTopicLabel = "件名",
    feedbackTopicPlaceholder = "機能要望、バグなど",
    feedbackMessageLabel = "内容",
    feedbackMessagePlaceholder = "アイデアや不具合の詳細を記入",
    feedbackContactLabel = "連絡先 (任意)",
    feedbackContactPlaceholder = "メールまたは ID",
    feedbackSendLabel = "送信",
    feedbackCloseLabel = "閉じる",
    feedbackShareLogLabel = "ログを共有",
    feedbackCancelLabel = "キャンセル",
    feedbackLastSentFormat = "最終送信: %1\$s",
    feedbackLogEmpty = "保存されたログはありません。",
    feedbackLogShareError = "ログを共有できませんでした。",
    feedbackLogNoApps = "共有できるアプリが見つかりません。",
    feedbackEmailError = "メールアプリを開けませんでした。記録はアカウント画面から後で共有できます。",
    feedbackEmailNoApp = "メールアプリがインストールされていません。記録はアカウント画面から後で共有できます。",
)
