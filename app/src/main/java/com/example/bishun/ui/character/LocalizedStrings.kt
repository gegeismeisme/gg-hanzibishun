...
private val defaultLibraryStrings = LibraryStrings(
    ...
    errorRead = "Unable to read the dictionary.
...
private fun localizedStringsJa(locale: Locale): LocalizedStrings {
    ...
    return base.copy(
        ...
        courseEmptyTitle = "???????????",
        courseEmptyDescription = "??HSK?????????????????????????",
        courseNoDataMessage = "????????????????????????????????",
        expandCharactersLabel = "?????",
        collapseCharactersLabel = "??",
        legendTitle = "?????",
        legendGesture = "??????????????????????????",
        courseLegendHint = "????????????????????????????",
        helpTitle = "????????????",
