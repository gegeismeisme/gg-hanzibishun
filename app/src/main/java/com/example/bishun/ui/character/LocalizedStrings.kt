...
private val japaneseAccountStrings = AccountStrings(
    title = "????????",
    signInCardTitle = "???????",
    signInDescriptionSignedIn = "???????????????????????????????????",
    signInDescriptionSignedOut = "?????????????????????????????????????????????????",
    signInButtonSignedIn = "??????",
    signInButtonSignedOut = "??????????????",
    courseCardTitle = "?????",
    courseDescriptionSignedOut = "HSK?????????????????????????????????????",
    courseDescriptionUnlocked = "????????????????????????????????????",
    courseDescriptionLocked = "??????????????????????????????????????",
    courseButtonSignedOut = "????????",
    courseButtonUnlocked = "??????",
    courseButtonLocked = "??????????",
    supportTitle = "?????????????",
    supportDescription = "?????????????????????????????????????????????????",
